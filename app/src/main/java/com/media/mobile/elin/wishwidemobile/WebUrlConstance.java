...
//    public static final String DOMAIN_NAME = "http://220.149.254.76/";  //회사 서버
    public static final String DOMAIN_NAME = "http://192.168.219.103:8080/";  //테스트 서버
    ...
    public static final String RECEIVED_GIFT_LIST_PATH = "mobile/gift/listReceivedGift";
