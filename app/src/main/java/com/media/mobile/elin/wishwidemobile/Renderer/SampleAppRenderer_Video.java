...
import com.media.mobile.elin.wishwidemobile.utils.VideoBackgroundShader;
import com.vuforia.*;

public class SampleAppRenderer_Video {


    private static final String LOGTAG = "SampleAppRenderer_Video";
