...
{
    private static final String LOGTAG = "VideoPlaybackRenderer2";
    ...
    public VideoPlaybackRenderer2(VideoPlayback2 activity, SampleApplicationSession_Video session)
    {
