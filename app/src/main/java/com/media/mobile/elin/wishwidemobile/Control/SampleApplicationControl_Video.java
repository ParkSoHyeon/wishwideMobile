...
package com.media.mobile.elin.wishwidemobile.Control;

import com.media.mobile.elin.wishwidemobile.Session.SampleApplicationException;
import com.vuforia.State;


//  Interface to be implemented by the activity which uses SampleApplicationSession_Video
public interface SampleApplicationControl_Video
{
