...
public class SampleApplicationSession_Video implements UpdateCallbackInterface
{
    ...
    public SampleApplicationSession_Video(SampleApplicationControl_Video sessionControl)
    {
